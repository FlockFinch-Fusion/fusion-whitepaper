...
cannot distinguish available evidence from missing evidence. Premature reliance
on a weaker source indicates that it cannot recognize where stronger judgment
is load-bearing. Allocation intelligence must improve both capability and the
