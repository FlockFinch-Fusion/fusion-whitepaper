...
available. Query--model interaction models provide one starting point
\citep{song2025irtrouter}; Fusion requires a richer, state-dependent map of
...
Prior work shows that multi-model interaction logs can support routing,
reasoning-pattern retrieval, and capability distillation
\citep{feng2026fusionfactory}. Fusion extends this learning substrate with
task state, evidence use, actions, and downstream outcomes.
