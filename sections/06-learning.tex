...
An asymmetric model pool can be copied. A routing graph can be reconstructed.
Neither is the durable advantage of Fusion. The compounding asset is an
empirical understanding of how capabilities interact with real tasks---and a
system that becomes better at allocation as that understanding grows.
