\section{Fusion: Allocation as Evidence Acquisition}

\systemname is Fumo Lab's answer to the intelligence allocation problem. Its
central insight is that a system does not need to predict the full intelligence
demand of a trajectory before the work begins. It can discover that demand
progressively by treating inference as a closed-loop process of evidence
acquisition.
